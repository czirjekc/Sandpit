<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="Users.aspx.cs" Inherits="Eu.Europa.Ec.Olaf.Gmsr.Administration.Users" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <asp:Label ID="lblItems1CountPrefix" runat="server" Text="Users:"></asp:Label>
            ...
            <div id="divHeader1" class="divHeader">
                <table id="tblStaticHeader1" class="tblStaticHeader" rules="all" width="1100px">
                    <thead>
                        <tr>
            ...
            <div id="divContainer1" class="divContainer" style="height: 400px;" onscroll="scrollDivHeader(1);">
                <asp:GridView ID="gvItems1" runat="server" DataKeyNames="Id" Width="1100px">
                    <Columns>
                        <asp:BoundField DataField="Surname" ItemStyle-Width="200px" />
                        <asp:BoundField DataField="FirstName" ItemStyle-Width="200px" />
                        <asp:BoundField DataField="Login" ItemStyle-Width="100px" />
                        <asp:BoundField DataField="Email" ItemStyle-Width="400px" />
