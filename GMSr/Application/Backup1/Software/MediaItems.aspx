<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="MediaItems.aspx.cs" Inherits="Eu.Europa.Ec.Olaf.Gmsr.Software.MediaItems" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">    
        ...
        <ContentTemplate>
            <asp:Label ID="lblItems1CountPrefix" runat="server" Text="Media Items:"></asp:Label>
            ...
            <div id="divHeader1" class="divHeader">
                <table id="tblStaticHeader1" class="tblStaticHeader" rules="all" width="1600px">
                    <thead>
                        <tr>
            ...
            <div id="divContainer1" class="divContainer" style="height: 400px;" onscroll="scrollDivHeader(1);">
                <asp:GridView ID="gvItems1" runat="server" DataKeyNames="Id" Width="1600px">
                    <Columns>
                        <asp:BoundField DataField="Id" ItemStyle-ForeColor="#88bfeb" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="100px" />
                        ...
                        <asp:BoundField DataField="Comment" ItemStyle-Width="600px" />
