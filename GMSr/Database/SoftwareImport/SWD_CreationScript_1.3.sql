GO
/****** Object:  Table [dbo].[SWD_Import]    Script Date: 03/23/2011 13:02:47 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SWD_Import]') AND type in (N'U'))
DROP TABLE [dbo].[SWD_Import]

GO
/****** Object:  Table [dbo].[SWD_Import]    Script Date: 03/23/2011 13:03:09 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Index [IX_SWD_Import]    Script Date: 03/23/2011 13:03:33 ******/
...
GO
/****** Object:  Table [dbo].[SWD_Product]    Script Date: 03/23/2011 14:07:27 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SWD_Product]') AND type in (N'U'))
DROP TABLE [dbo].[SWD_Product]

GO
/****** Object:  Table [dbo].[SWD_Product]    Script Date: 03/23/2011 14:08:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_SWD_Product]    Script Date: 03/23/2011 14:08:56 ******/
...
GO
GO
/****** Object:  Table [dbo].[SWD_ProductMatch]    Script Date: 03/23/2011 14:09:12 ******/
...
GO
/****** Object:  Table [dbo].[SWD_ProductMatch]    Script Date: 03/23/2011 14:09:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
GO
/****** Object:  Table [dbo].[SWD_Uninstallation]    Script Date: 03/23/2011 14:10:14 ******/
...
GO
/****** Object:  Table [dbo].[SWD_Uninstallation]    Script Date: 03/23/2011 14:10:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SWD_Installation]    Script Date: 03/23/2011 13:11:20 ******/
...
GO
/****** Object:  Table [dbo].[SWD_Installation]    Script Date: 03/23/2011 13:14:00 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_SWD_Installation]    Script Date: 03/23/2011 13:15:47 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SWD_ImportInstallations]    Script Date: 03/23/2011 14:11:45 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SWD_ImportInstallations]    Script Date: 03/23/2011 14:11:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SWD_ProcessImports]    Script Date: 03/23/2011 14:12:05 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_SWD_ProcessImports]    Script Date: 03/23/2011 14:12:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	-- Add new unknown hardware to the SWD_UnknownHardware table
	INSERT INTO SWD_UnknownHardware
	...
	WHERE 
	NOT EXISTS (SELECT * FROM Olaf_Hard WHERE OlafHardName = ImportHardware.MachineName)
	AND
